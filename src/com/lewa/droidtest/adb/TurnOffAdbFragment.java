...
public class TurnOffAdbFragment extends Fragment {
  ...
  /*
        Button buttonTurnoffUsb = (Button)v.findViewById(R.id.buttonTurnoffUsb);
        ...
        Button toggle = (Button)v.findViewById(R.id.buttonTurnoffUsb);
        buttonTurnoffUsb.setOnClickListener(new View.OnClickListener() {
  ...
  */
    ...
    private void updateAdb() {
        ...
        int adb = Settings.Secure.getInt(mActivity.getContentResolver(), Settings.Secure.ADB_ENABLED, 0);
        textToogleAdb.setText("" + adb);
    }

    public void toogleDown(View v) {
        int disableStatusBar = Settings.Secure.getInt(mActivity.getContentResolver(), "disableStatusBar", 0);
        disableStatusBar = 1 - disableStatusBar;
        Settings.Secure.putInt(mActivity.getContentResolver(), "disableStatusBar", disableStatusBar);
        updateDisableStatusBar();    
   }   
    ...
    public void statusBarSettings(View v) {
        ...
        intent.setComponent(new ComponentName("com.android.systemui", "com.android.systemui.statusbar.switchwidget.PhoneStatusbarSettings"));
    ...
    private void turnOffUsb() {
        Intent intent = new Intent();
        intent.setComponent(new ComponentName("com.android.systemui", "com.android.systemui.usb.UsbModeSelection"));
        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        intent = intent.setAction("UsbModeSelection.action.CHARGE_ONLY");
        startActivity(intent);
    }
}
